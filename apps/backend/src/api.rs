...
#[openapi(
    ...
    paths(
        ...
        crate::http::images::describe_image,
        crate::http::images::reorder_images,
    ...
    components(schemas(
        ...
        crate::images::ProductImage,
        crate::images::ImageState,
        crate::http::images::WantedOrder,
        crate::http::images::WantedAlternativeText,
        crate::tax::VatRate,
